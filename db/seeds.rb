...
corfu = Island.create(name: "Corfu", 
    image: "https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/vlacherna-monastery-rat-island-on-background-corfu-royalty-free-image-1582042039.jpg?crop=1xw:0.91602xh;center,top&resize=980:*g",
    main_page: false,
...
santorini = Island.create(name: "Santorini", 
    image: "https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/blue-sea-in-summer-greek-islands-santorini-royalty-free-image-1582045104.jpg?crop=1.00xw:0.918xh;0,0.0816xh&resize=980:*",
    main_page: true,
...
kastellorizo = Island.create(name: "Kastellorizo", 
    ...
    main_page: false,
    short_bio: "A small, pretty island in the Dodecanese, Kastellorizo is in the easternmost tip of Greece and very close to Turkey, offering unique architecture and colourful houses in its main town.",
    long_bio: "A small, pretty island in the Dodecanese, Kastellorizo is in the easternmost tip of Greece and very close to Turkey, offering unique architecture and colourful houses in its main town. You'll find a cluster of islets and plenty of marine life to discover in its clear waters.
